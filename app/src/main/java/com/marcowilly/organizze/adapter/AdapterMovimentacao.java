package com.marcowilly.organizze.adapter;
...
public final class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (movimentacao.getTipo().equals(Movimentacao.DESPESA)) {
